...
STANFORD_DATA_PATH = r"D:/Datasets/stanford-question-answering-dataset/"
WORD2VEC_FILE = 'C:/Users/Joseph Giroux/Datasets/GoogleNews-vectors-negative300.bin'
OUTPUT_DATA_PATH = r"C:/Users/Joseph Giroux/Datasets/"  # path to save results
...
DF_PICKLE = os.path.join(OUTPUT_DATA_PATH, "df.pkl")
...
def get_stanford_qa_and_vectors_pickled():
    ...
    question_data, text_vectors, text_words = load_questions_and_text_vectors()
    return df, question_data, text_vectors, text_words
